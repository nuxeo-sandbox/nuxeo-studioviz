 ...
 * @author mgena
 */
@Operation(id=GenerateViewText.ID, category=Constants.CAT_EXECUTION, label="GenerateViewText", description="")
public class GenerateViewText {

    public static final String ID = "GenerateViewText";
    private Log logger = LogFactory.getLog(GenerateViewText.class);
    ...
    public Blob run() {
    	...
    	try {
		    ...
		    blob = svs.generateViewTextFromXML(url, null);
