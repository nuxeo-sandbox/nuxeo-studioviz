 ...
 * @author mgena
 */
public class GraphVizService extends DefaultComponent {
    ...
    /**
     * 
     * @param folderName where the file will be generated. This will be a subfolder of the folder named graphviz, that will be available under the nuxeo home path.
     * @param inputFileName the dot file name containing the description of the graphic
     ...
     * @throws IOException 
     */
    public void generate(String inputFilePath, String outputFilePath, String format) throws CommandNotAvailable, IOException{
	    ...
	    parameters.addNamedParameter("inputFile", inputFilePath);
	    parameters.addNamedParameter("format", format);
	    parameters.addNamedParameter("outputFile", outputFilePath);
